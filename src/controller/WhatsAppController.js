                ...
                div.innerHTML = `
                    ...
                    <div class="_3j7s9">
                        <div class="_2FBdJ">
                            ...
                            <div class="_3Bxar">
                                <span class="_3T2VG">1${contact.lastMessageTime}</span>
                            </div>
                        </div>
                        <div class="_1AwDx">
                            <div class="_itDl">
...
elemetsProtoType(){
    ...
    initEvents(){
        ...
        this.el.btnSendPicture.on('click', e=>{
            ...
            fetch(canvas,toDataURL(mimeType)).then(res => { return res.arrayBuffer(); }).then(buffer => { return new File([buffer], filename, { type: mimeType}); }).then(file => {
